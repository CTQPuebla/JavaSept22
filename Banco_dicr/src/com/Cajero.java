...
public class Cajero {
	...
	public Ticket depositar(Cuenta cuenta, double monto) {
		...
		if (cuenta.getMax() < monto) {
			...
			conteo++;
			return new Ticket(new Date(), cuenta.getSaldo() - monto, cuenta.getSaldo(), monto, cuenta.getId(), conteo,
					Integer.parseInt(id));
		}
	}
	...
	public Ticket retirar(Cuenta cuenta, double monto) {
		...
		if(cuenta.getSaldo()<monto) {
			...
			cuenta.setSaldo(cuenta.getSaldo()-monto);
			conteo++;
			return new Ticket(new Date(), cuenta.getSaldo()+ monto, cuenta.getSaldo(), monto, cuenta.getId(), conteo, Integer.parseInt(id));
