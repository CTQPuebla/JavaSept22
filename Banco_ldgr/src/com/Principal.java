...
public class Principal {
	...
	public static void main(String[] args) {
		...
		Cuenta c2 = new Cuenta("01", "CV1",5000.00, 1000.00, 15000.00, new Date(), 1);
		Cuenta c3 = new Cuenta("01", "CV1",400.00, 50.00, 10000.00, new Date(), 1);
		Cuenta c4 = new Cuenta("01", "CV1",1500.00, 200.00, 8000.00, new Date(), 1);
