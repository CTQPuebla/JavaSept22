...
public class Ticket {
	...
	public String toString() {
		return "Ticket [fecha=" + fecha + ", saldoAnterior=" + saldoAnterior + ", saldoActual=" + saldoActual
				+ ", cantidadOperada=" + cantidadOperada + ", numeroCuenta=" + numeroCuenta + ", ubicacion=" + ubicacion
				+ ", folioOperacion=" + folioOperacion + ", idCajero=" + idCajero + "]";
	}
