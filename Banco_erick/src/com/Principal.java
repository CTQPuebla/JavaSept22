...
public class Principal {
    ...
    Cuenta c2 = new Cuenta("02", "CV2", 500.00, 1000.00, 1500.00, new Date(),"1"); 	
    Cuenta c3 = new Cuenta("03", "CV3", 400.00, 50.00, 10000.00, new Date(),"1"); 	
   	...
   	System.out.println(cajero.retirar(c3, 3000));
   	System.out.println(cajero.depositar(c4, 10));
   	System.out.println(cajero.retirar(c2, 20));
   	System.out.println(cajero.transferir(c1,c4, 1500));
